...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getStoredCredentials() {
    return {
      ...
      gbpAccessStatus: localStorage.getItem('seo_gbp_access_status') || 'not-requested',
      gbpCaseId: localStorage.getItem('seo_gbp_case_id') || '',
      gbpSubmittedAt: localStorage.getItem('seo_gbp_submitted_at') || '',
      gscJson: '',
